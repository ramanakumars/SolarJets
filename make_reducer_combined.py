...
data_T3_data=data_T3T4.data[data_T3T4.data['task']=='T3'] #Only use the first Yes/No Jet question, T4 is the question is there a second jet

data_combined=data_T0.data.copy()
for i in range(len(data_T3_data)): #Print which subjects were not in first workflow but are in the second (should not happen)
