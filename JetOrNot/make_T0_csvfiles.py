...
#Make the csv files 
data_T0_file = ascii.read('question_reducer_jet_or_not.csv',format='csv')
...
data_T0_file.rename_column('data.no-there-are-no-jets-in-this-image-sequence', 'data.no')
data_T0_file.rename_column('data.yes-there-is-at-least-one-jet-in-this-image-sequence', 'data.yes')
...
data_T0.csv_SOL(SOL_T0, obs_time_T0, Ans_T0, agreement_T0,jet_mask_T0,non_jet_mask_T0, 'T0',filenames_T0,end_time_T0)
